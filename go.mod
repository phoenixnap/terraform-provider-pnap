...
require (
	github.com/PNAP/go-sdk-helper-bmc v0.18.0
	...
	github.com/phoenixnap/go-sdk-bmc/ranchersolutionapi/v3 v3.1.0
	github.com/phoenixnap/go-sdk-bmc/tagapi/v3 v3.0.3
